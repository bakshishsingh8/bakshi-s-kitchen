            ...
            {cartItems.map((it) => (
              <li key={it.childId} className="cart-row">
                ...
                {/* <button
                  ...
                  onClick={() => dispatch(removeItem(it.childId))}
                >
                  ×
                </button> */}
              </li>
...
// import { ShoppingCart } from "lucide-react"; // using lucide-react for icon
...
//   console.log(counter?.foodItem,'food item')
...
//       >
//         <ShoppingCart size={28} />
//         { <span className="cart-badge">{counter?.foodItem?.length}</span>}
//       </button>
...
//                 </div>
//                 <div className="cart-qty">
//                   <button className="qty-btn" onClick={() => dec(it.key)}>-</button>
//                   <span className="qty-val">{it.qty}</span>
//                   <button className="qty-btn" onClick={() => inc(it.key)}>+</button>
//                 </div>
//                 <div className="cart-line">₹{it.price * it.qty}</div>
//                 <button className="remove-btn" onClick={() => remove(it.key)}>×</button>
//               </li>
//             ))}
//           </ul>
//         )}
...
//           <div className="cart-actions">
//             <button className="clear-btn" disabled={items.length === 0} onClick={clear}>Clear</button>
